...
supergausfit <- function(input,bereich,weighted=FALSE,sig0=0,N0=0,N01=2000000,sig01=80,mu01=750){ #--- Fitten der Exponentialfunktion
  ...
  {
    err=daten$sy
    fit = nls(thegaussian,daten,weights=1/err^2,start=list(C=ymin,N=N0,mu=mu0,sig=sig0, N1=N0, mu1=mu0, sig1=sig0))
  }
  else
    fit = nls(thegaussian,daten,start=list(C=ymin,N=ymax,mu=mu0,sig=sig0, N1=N0, mu1=mu0, sig1=sig0))
