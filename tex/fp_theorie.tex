...
\graX[]{Doppler}{Dopplerverbreiterung}{Dopplerverbreiterung der Emissionsenergie führt zu Überlapp mit Absorbtionspeak und damit zu Resonanzabsorbtion bei Raumtemperatur \label{Doppler}  \cite{jakobs}}
...
\graX[]{Moessbauer_Spektrum}{Moessbauerspektrum}{Moessbauerspektrum oben: Dopplerverschiebung der Energie als Ausgleich zum Rückstoßverlust unten: Transmission hinter dem Absorber in Abhängigkeit der Geschwinidgkeit \label{KILL THE STICKMAN} \cite{jakobs}}
...
\graX{Debye-Waller-Faktor}{Temperaturabhängigkeit des Debye-Waller-Faktor}{Temperaturabhängigkeit des Debye-Waller-Faktor für Eisen und Rhenium \label{DWF} \cite{jakobs}}
