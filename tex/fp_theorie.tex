...
\graX[]{Doppler}{Dopplerverbreitung}{Dopplerverbreiterung der Emissionsenergie führt zu Überlapp mit Absorbtionspeak und damit zu Resonanzabsorbtion bei Raumtemperatur \label{Doppler}  \cite{jakobs}}
...
\gra[]{Moessbauer_Spektrum}{Moessbauerspektrum}{Moessbauerspektrum oben: Dopplerverschiebung der Energie als Ausgleich zum Rückstoßverlust unten: Transmission hinter dem Absorber in Abhängigkeit der Geschwinidgkeit \label{KILL THE STICKMAN} \cite{jakobs}}
